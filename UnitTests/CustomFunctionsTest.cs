...
namespace JUST.UnitTests
{
    ...
    public class CustomFunctionsTests
    {
        ...
        public void XmlTest()
        {
            string inputSpecial = File.ReadAllText("../../../../Examples/Input_Customfunction_Nestedresult.json");
            string transformer = File.ReadAllText("../../../../Examples/Transformer_customfunctionnestedresult.json");
